...
const commentOnQuestionValidatePipe = new zod_validation_pipe_1.ZodValidationPipe(commentOnQuestionBodySchema);
let CommentOnQuestionController = class CommentOnQuestionController {
    constructor(commentOnQuestionUseCase) {
        this.commentOnQuestionUseCase = commentOnQuestionUseCase;
    }
    async handler(user, body, questionId) {
        const { content } = body;
...
__decorate([
    ...
    __param(1, (0, common_1.Body)(commentOnQuestionValidatePipe)),
    __param(2, (0, common_1.Param)('questionId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, String]),
    __metadata("design:returntype", Promise)
], CommentOnQuestionController.prototype, "handler", null);
